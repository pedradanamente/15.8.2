    ...
    <div style="clear:both;">
		<form class="navbar-form navbar-left" role="search" action="<?php echo $caminho; ?>index.php?p=pesquisar&subp=orcamentos&seek=">
			<div class="form-group">
				<input style="display:none;" name="p" type="text" class="form-control" placeholder="Search" value="pesquisar" />
				<input style="display:none;" name="subp" type="text" class="form-control" placeholder="Search" value="orcamentos" />
			</div>
			<div class="form-group">

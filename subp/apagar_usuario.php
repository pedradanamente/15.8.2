...
<ol class="breadcrumb submenutitulo">
    ...
    <li class="fl" style="margin-top:0px;">Apagar usuário</li>
<li style="clear:both;"></li>
</ol>
<!-- Button and dropdown subp -->

<div class="col-md-6" >
    <form action="<?php echo $caminho; ?>pp/apagar_usuario.php" method="post">
        <div class="form-group">
            ...
            <div style="font-weight:bold;float:left;color:#3F79CF;"><img style="margin-top:-2px;" src="<?php echo $caminho; ?>images/apagar.png" width="18"/>
                Tem certeza que deseja apagar o usuário <?php echo Ver_nome($id); ?> ?
            </div>
        </div>
